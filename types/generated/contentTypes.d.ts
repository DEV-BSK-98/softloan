...
export interface ApiApplicantApplicant extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    credit_evaluations: Schema.Attribute.Relation<
      'oneToMany',
      'api::credit-evaluation.credit-evaluation'
    >;
...
export interface ApiCollateralCollateral extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    OwnershipProof: Schema.Attribute.String &
      Schema.Attribute.CustomField<
        'plugin::bold-title-editor.bold-title',
        {
          output: 'html';
...
export interface ApiCreditEvaluationCreditEvaluation
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    CreditReport: Schema.Attribute.String &
      Schema.Attribute.CustomField<
        'plugin::bold-title-editor.bold-title',
        {
          output: 'html';
...
export interface ApiEmploymentDetailEmploymentDetail
  ...
  info: {
    ...
    pluralName: 'employment-details';
    singularName: 'employment-detail';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    AnnualIncome: Schema.Attribute.Decimal & Schema.Attribute.Required;
    applicant: Schema.Attribute.Relation<
      'oneToOne',
      'api::applicant.applicant'
    >;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    EmployerName: Schema.Attribute.String & Schema.Attribute.Required;
    EmploymentStatus: Schema.Attribute.String & Schema.Attribute.Required;
    EmploymentType: Schema.Attribute.String & Schema.Attribute.Required;
    JobTitle: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::employment-detail.employment-detail'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
